...
import main.enums.InstructionType;
...
import main.service.SplitWiseService;
...
public class SplitWiseMain {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            InstructionType type = InstructionType.valueOf(commands[0]);
            switch (type){
                case EXPENSE:
                    ...
                    switch (expense){
                        case EQUAL:
                            ...
                            service.addExpense(
                                    ExpenseType.EQUAL, amountSpend, userName, splits, new ExpenseDetails("GoaFlight")
                            );
                            break;
                        case EXACT:
                            for (int i = 0; i < totalMembers; i++) {
                            ...
                            service.addExpense(
                                    ExpenseType.EXACT, amountSpend, userName, splits, new ExpenseDetails("CabTickets")
                            );
                        ...
                        case PERCENT:
                            ...
                            service.addExpense(
                                    ExpenseType.PERCENT, amountSpend, userName, splits, new ExpenseDetails("Dinner")
                            );
                            break;
                    }
                    break;
                ...
                case QUIT:
                    ...
                    return;
                default:
                    System.out.println("Unexpected Argument Found");
                    break;
            }
